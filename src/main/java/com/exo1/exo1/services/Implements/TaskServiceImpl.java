...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskDTO updateTask(Long id, TaskDTO taskDTO) {
        ...
        if (taskDTO.getProject() != null) {
            existingTask.setProject(ProjectMapper.INSTANCE.toProjectEntity(taskDTO.getProject()));
        }
        if (taskDTO.getUser() != null) {
            existingTask.setUser(UserMapper.INSTANCE.toUserEntity(taskDTO.getUser()));
        }
